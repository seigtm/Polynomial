...
void PolynomialTests::SetUp() {
    expected.multiplication = Polynomial<int>({ 5, 10, 15, 20, 25 });
    expected.additionWithEquality = Polynomial<float>({ 3.0, -15.1, 8.17 });
}

TEST_F(PolynomialTests, additionWithEquality) {
    Polynomial<float> polynomial({ 2.0, -15.1, 8.17 });
